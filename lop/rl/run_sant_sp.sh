...
#SBATCH --output=/scratch/gautschi/shin283/loss-of-plasticity/lop/rl/logs/%j_sant_sp.out
#SBATCH --error=/scratch/gautschi/shin283/loss-of-plasticity/lop/rl/logs/%j_sant_sp.err

# ============================================
# PPO SlipperyAnt-v3 Shrink & Perturb
# Usage: sbatch run_sant_sp.sh
# ============================================
