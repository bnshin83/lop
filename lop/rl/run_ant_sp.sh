...
#SBATCH --output=/scratch/gautschi/shin283/loss-of-plasticity/lop/rl/logs/%j_ant_sp.out
#SBATCH --error=/scratch/gautschi/shin283/loss-of-plasticity/lop/rl/logs/%j_ant_sp.err

# ============================================
# PPO Ant-v4 Shrink & Perturb
# Usage: sbatch run_ant_sp.sh
# ============================================
...
python -u run_ppo_wandb.py \
    ...
    --device cuda \
    --no-resume \
    --run-suffix fresh_${SLURM_JOB_ID}
